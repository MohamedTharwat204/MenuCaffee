    ...
    return (
        <div className=' '>
            ...
            <div className="flex  sm:w-[50%]   justify-center  items-center  ">
                <div className="border w-[65%] md:w-[40%] bg-[#706760d5]   shadow-emerald-600  shadow-2xl   left-1/2 -translate-x-1/2   border-[#706760d3] py-1 flex justify-around items-center gap-1  h-20 rounded-2xl   md:top-2 top-310  mb-1 md:mb-0   fixed">
